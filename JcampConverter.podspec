...
Pod::Spec.new do |spec|
  ...
  spec.description  = <<-DESC
                This is library for parsing *.dx or *.jdx files
                   DESC

  spec.homepage     = "https://github.com/baolanlequang/jcamp-converter-ios"
  ...
  spec.source_files  = "JcampConverter/JcampConverter/Jcamp/*.{h,m,swift}"
